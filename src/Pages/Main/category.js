...
const Category = ({fetchtodo,todo,loading}) => {
    ...
    return ( 
        <div className="todo onboard">
            <div className="onboard-inner">
                <div className="todo-head-nav">
                    <nav>
                        <li onClick={handleCompleted} className={show === 1 ? `nav-active nav-set`: 'nav-set'}>Completed</li>
                        <li onClick={handleUncompleted} className={show === 2 ? `nav-active nav-set`: 'nav-set'}>Uncompleted</li>
                    </nav>
                </div>
