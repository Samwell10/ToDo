    ...
    return ( 
        <div className="Main onboard">
            <div className="onboard-inner">
                <h2 className="onboard-head">Create to do list</h2>
                <p className="onboard-text">Choose your to do list color theme:</p>
                <div className="main-body">
                    <div className="platellet">
                        <img src={card1}></img>
                    </div>
                    <div className="platellet platellet-bottom">
                        <img src={card2}></img>
                    </div>
                    <div className="platellet platellet-bottom">
                        <img src={card3}></img>
                    ...
                    <Link to="/list"><button className="submit">Open DoItApp</button></Link>
                </div>
            </div>
            <div className="blob2">
